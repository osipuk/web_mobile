...
export default class Report_p extends Component {
    ...
    btnReportUser = async () => {
        ...
        let url = config.baseURL + "user_report_submit.php?user_id=" + user_id_post + "&message=" + this.state.message + '&other_user_id=' + this.state.other_user_id;
        ...
        return (
            <View style={{ flex: 1, backgroundColor: color1.theme_app, }}>
                ...
                <KeyboardAwareScrollView contentContainerStyle={{ flex: 1 }}>
                    ...
                    <View style={[styles.reportp_body]}>
