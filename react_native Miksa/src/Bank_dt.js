...
export default class Bank_dt extends Component {
    ...
    submitBankDetails = async () => {
        ...
        Keyboard.dismiss()
        let { account_type, bank_name, account_no, identification_no, phone_no, email, surname, second_surname, name } = this.state;
        ...
        data.append("signup_type", "add_bank")
                ...
                >
                    <View style={{ backgroundColor: "#00000030", flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 20 }}>
                        ...
                        <View style={{ width: "100%", position: 'absolute', bottom: 20 }}>
                            ...
                            <View style={{ backgroundColor: "#ffffff", width: "100%", height: 150 }}>
                ...
                <KeyboardAwareScrollView>
                    ...
                    <View style={styles.bankody}>
                        <View style={{ marginBottom: 15 }}>
                            <Text style={styles.bankdt}>{Lang_chg.txt_enter_bank_details[config.language]}</Text>
