...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('google_ads_group_data', function (Blueprint $table) {
            $table->id();
            $table->integer('google_ads_group_id')->nullable()->default(null);
    ...
    {
        Schema::dropIfExists('google_ads_group_data');
    }
};
