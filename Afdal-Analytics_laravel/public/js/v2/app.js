...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            ...
            '<div class="d-flex flex-column">' +
                '<div class="ranges p-2"></div>' +
                '<div class="d-flex flex-column flex-sm-row">' +
                '<div class="drp-calendar left">' +
                    '<div class="calendar-table calender-table-width"></div>' +
        ...
        if (typeof options.ranges === 'object') {
            ...
            var list = '<div class="row g-3">';
            var a=0;
            for (range in this.ranges) {
                a++;
                list += '<div class="col-6 col-sm-auto"><div data-id="'+a+'" data-range-key="' + range + '" class=" d-flex flex-row justify-content-between align-items-center g-20 g-3-768 datepicker-predined-container"><span data-id="'+a+'" data-range-key="' + range + '">' + range + '</span><span data-id="'+a+'" data-range-key="' + range + '" class="datepicker-tick-icon" id="normal'+a+'"><svg data-id="'+a+'" data-range-key="' + range + '" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.9995 0.166016C5.04114 0.166016 0.166138 5.04102 0.166138 10.9993C0.166138 16.9577 5.04114 21.8327 10.9995 21.8327C16.9578 21.8327 21.8328 16.9577 21.8328 10.9993C21.8328 5.04102 16.9578 0.166016 10.9995 0.166016ZM15.5495 9.15768L10.3495 14.3577C9.91614 14.791 9.26614 14.791 8.8328 14.3577L6.44947 11.9743C6.01614 11.541 6.01614 10.891 6.44947 10.4577C6.8828 10.0243 7.5328 10.0243 7.96614 10.4577L9.59114 12.0827L14.0328 7.64102C14.4661 7.20768 15.1161 7.20768 15.5495 7.64102C15.9828 8.07435 15.9828 8.72435 15.5495 9.15768Z" fill="#D0D8E3"/></svg></span><span data-id="'+a+'" data-range-key="' + range + '" class="datepicker-tick-icon-slected d-none" id="active'+a+'"><svg data-id="'+a+'" data-range-key="' + range + '" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.9995 0.166016C5.04114 0.166016 0.166138 5.04102 0.166138 10.9993C0.166138 16.9577 5.04114 21.8327 10.9995 21.8327C16.9578 21.8327 21.8328 16.9577 21.8328 10.9993C21.8328 5.04102 16.9578 0.166016 10.9995 0.166016ZM15.5495 9.15768L10.3495 14.3577C9.91614 14.791 9.26614 14.791 8.8328 14.3577L6.44947 11.9743C6.01614 11.541 6.01614 10.891 6.44947 10.4577C6.8828 10.0243 7.5328 10.0243 7.96614 10.4577L9.59114 12.0827L14.0328 7.64102C14.4661 7.20768 15.1161 7.20768 15.5495 7.64102C15.9828 8.07435 15.9828 8.72435 15.5495 9.15768Z" fill="#2DA771"/></svg></span></div></div>';
            }
            // if (this.showCustomRangeLabel) {
            //     list += '<li data-range-key="' + this.locale.customRangeLabel + '" class="d-flex flex-row jsutify-content-between align-items-center datepicker-predined-container">' + this.locale.customRangeLabel + '</li>';
            // }
            list += '</div>';
        ...
        this.container.find('.ranges')
            .on('click.daterangepicker', '.datepicker-predined-container', $.proxy(this.clickRange, this));
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function() {
            ...
            this.container.find('.ranges .datepicker-predined-container').removeClass('active');
        ...
        renderCalendar: function(side) {
            ...
            html += '<th colspan="5" class="month" style="color: #153A5A;">' + dateHtml + '</th>';
        ...
        clickRange: function(e) {
            ...
            var t=e.target;
            // datepicker-tick-icon
            var el1=document.getElementsByClassName("datepicker-tick-icon-slected");
            $(el1).addClass('d-none');
            var el2=document.getElementsByClassName("datepicker-tick-icon");
            $(el2).removeClass('d-none');
            var id = e.target.getAttribute('data-id');
            $('#active'+id).removeClass('d-none');
            $('#normal'+id).addClass('d-none');
        ...
        calculateChosenLabel: function () {
            ...
            for (var range in this.ranges) {
              if (this.timePicker) {
                    ...
                    if (this.startDate.format(format) == this.ranges[range][0].format(format) && this.endDate.format(format) == this.ranges[range][1].format(format)) {
                        customRange = false;
                        var el4=document.getElementsByClassName("datepicker-tick-icon-slected");
                        $(el4).addClass('d-none');
                        var el5=document.getElementsByClassName("datepicker-tick-icon");
                        $(el5).removeClass('d-none');
                        this.container.find('.ranges .datepicker-predined-container:eq(' + i + ') .datepicker-tick-icon').addClass('d-none');
                        this.container.find('.ranges .datepicker-predined-container:eq(' + i + ') .datepicker-tick-icon-slected').removeClass('d-none');
                        this.chosenLabel = this.container.find('.ranges .datepicker-predined-container:eq(' + i + ')').addClass('active').attr('data-range-key');
                        break;
                    }
                } else {
            ...
            if (customRange) {
                if (this.showCustomRangeLabel) {
                    this.chosenLabel = this.container.find('.ranges .datepicker-predined-container:last').addClass('active').attr('data-range-key');
                } else {
...
$(document).ready(function () {
    if (window.innerWidth > 768 && window.innerWidth <= 992) {
        $("#main-section").removeClass("addpaddingforhome");
        $("#main-section").addClass("addpaddingforhome50");
        $("#template-footer-custom").removeClass("addpaddingforhome");
        $("#template-footer-custom").addClass("addpaddingforhome50");
        // $(".dashboard-numbers-card").addClass("demo-stats-card-onclose-sidebar");
        // $(".gender-graph-card").addClass("gender-graph-card-closesidebar");
        // $(".dashboard-country-card").addClass("dashboard-country-card-closesidebar");
        // $(".demo-first-section-left").addClass("demo-first-section-left-onclosesidebar");
        // $(".gender-graph-card-first-section").addClass("gender-graph-card-first-section-closesidebar");
        $("#upgrade-alert").hide();

        isMenuOpen = false;
    }else if (window.innerWidth <= 768) {
        $("#main-section").removeClass("addpaddingforhome");
        $("#main-section").removeClass("addpaddingforhome50");
        $("#template-footer-custom").removeClass("addpaddingforhome");
        $("#template-footer-custom").removeClass("addpaddingforhome50");
...
function closeMenu() {
    ...
    if (isMenuOpen) {
        ...
        setTimeout(() => {
            ...
            $("#main-section").removeClass("addpaddingforhome50");
            $("#template-footer-custom").removeClass("addpaddingforhome50");
            // $(".dashboard-numbers-card").removeClass("demo-stats-card-onclose-sidebar");
            // $(".gender-graph-card").removeClass("gender-graph-card-closesidebar");
            // $(".dashboard-country-card").removeClass("dashboard-country-card-closesidebar");
            // $(".demo-first-section-left").removeClass("demo-first-section-left-onclosesidebar");
            // $(".gender-graph-card-first-section").removeClass("gender-graph-card-first-section-closesidebar");
            $("#main-section").addClass("addpaddingforhome");
            $("#template-footer-custom").addClass("addpaddingforhome");
            $("#upgrade-alert").show();
        }, 200)
    }
