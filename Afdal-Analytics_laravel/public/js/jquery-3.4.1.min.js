...
var NUMBERS_LIST = ['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '+']; // $('#blog-slider').owlCarousel({
//     loop: true,
//     center: true,
//     items: 3,
//     margin: 20,
...
function closeMenu() {
  ...
  if (isMenuOpen) {
    $(".sidebar-wrapper .show-menu-name").toggleClass("hide-menu-name"); // $(".dashboard-header").css("width", "calc(100% - 70px)")
    ...
    isMenuOpen = true;
    setTimeout(function () {
      $(".sidebar-wrapper .show-menu-name").toggleClass("hide-menu-name"); // $(".dashboard-header").css("width", "calc(100% - 270px)")
...
function parallax() {
  var s = document.querySelector(".header-features");

  if (!s) {
    return;
  }

  var yPos = 0 - window.pageYOffset / 115;
...
var nameEnglishRegEx = /^([a-zA-Z\u0600-\u065F\u066A-\u06EF\u06FA-\u06FF]+\s)+[a-zA-Z\u0600-\u065F\u066A-\u06EF\u06FA-\u06FF]+$/;
var emailRegEx = /^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/;
var arabicNameRegEx = /[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FF]/;
var facilityRegEx = /^[a-zA-Z0-9\u0621-\u064A\u0660-\u0669\s]{2,}$/; // const phoneRegEx = /^\d{1}\d{4}\d{4}\d{2}$/;
// const phoneRegExWithPlus = /^\+\d{1}\d{4}\d{4}\d{2}$/;
// const countryEnglishRegEx = /^[a-zA-Z]*$/;
// const countryArabRegEx = /[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FF\s]/

var passCapcha = false;
var allSubscribeFormInputsAreValid = false;
var errorMap = ["Invalid number", "Invalid country code", "Your phone number is too short", "Your phone number is too long"];
var errorMapArab = ["رقم هاتفك غير صالح", "رمز بلدك غير صالح", "رقم هاتفك قصير جدًا", "رقم هاتفك طويل جدًا"];
var iti;
$(document).ready(function () {
  //
  ...
  var $flagContainer = $(".iti__flag-container");

  if ($flagContainer.length) {
    $flagContainer[0].remove();
  }

  var $subscribeInputName = $(".subscribe .subscribe__input.name");

  if ($subscribeInputName.length) {
    $subscribeInputName[0].addEventListener('blur', function (event) {
  ...
  var $subscribeInputEmail = $(".subscribe .subscribe__input.name");

  if ($subscribeInputEmail.length) {
    $subscribeInputEmail[0].addEventListener('blur', function (event) {
  ...
  var $subscribeInputPhone = $(".subscribe .subscribe__input.phone");

  if ($subscribeInputPhone.length) {
    $subscribeInputPhone[0].addEventListener('blur', function (event) {
  ...
  var $subscribeInputFacilityName = $(".subscribe .subscribe__input.facility-name");

  if ($subscribeInputFacilityName.length) {
    $subscribeInputFacilityName[0].addEventListener('blur', function (event) {
  ...
  var $subscribeInputCountry = $(".subscribe .subscribe__input.country");

  if ($subscribeInputCountry.length) {
    $subscribeInputCountry[0].addEventListener('blur', function (event) {
  ...
  $(".subscribe .subscribe__submit").click(function (event) {
    if (grecaptcha.getResponse() == "") {
      ...
      if ($(".subscribe__submit.disabled").length === 0) {
        var phoneValue = $(".subscribe .subscribe__input.phone")[0].value;
        ...
        passCapcha = false; // $(".subscribe .modal-window")[0].classList.add('show')
...
function validateInput(inputType) {
  switch (inputType) {
    ...
    case 'phone':
      ...
      $(".subscribe .subscribe__input.phone")[0].value = $(".subscribe .subscribe__input.phone")[0].value.split('').map(function (letter) {
...
function check() {
  setTimeout(function () {
    var countryLength = $('.iti__country').length;

    for (var i = 0; i < countryLength; i++) {
      $('.iti__country')[i].addEventListener('click', function () {
        validateInput('phone');
      });
    }
  }, 50);
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./public/assets/js/jquery-3.4.1.min.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./public/assets/js/popper.min.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./public/assets/js/bootstrap.min.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./public/assets/js/custom.js")))
