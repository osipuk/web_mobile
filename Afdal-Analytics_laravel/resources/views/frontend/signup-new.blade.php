...
<div class="sign-up-4k">
    <div class="circle-wrapper-block">
        ...
        <form class="sign-up-form" action="{{url('register')}}" method="post" name="signupForm">
            ...
            <h3 class="sign-up-title font-74-weight-700 text-white text-center text-nowrap">{{__('Sign Up')}}</h3>
            <p class="sign-up-subtitle text-center text-white signup-page-link-signin sign-up-sub signup-rev font-20-lh-42-semi-bold">
                <span class="signup-already-have-account">{{__('Already have an account?')}}</span>
                <a href="{{ url('login') }}" class="sign-in-link-on-sign-up">
            ...
            <div class="forms-container">
                <div class="forms-wrapper small text-right">
                    ...
                    <label class="d-block text-white sign-up-lables text-left-en">{{__('First Name')}} <span
                ...
                <div class="forms-wrapper small text-right">
                    <label class="d-block text-white sign-up-lables text-left-en">{{__('Last Name')}} <span
                            class='signup-star'>*</span></label>
            ...
            <div class="forms-wrapper big text-right">
                <label class="d-block text-white sign-up-lables text-left-en">{{__('Email')}} <span
                        class='signup-star'>*</span></label>
            ...
            <div class="forms-container">
                ...
                <div class="forms-wrapper small text-right">
                    <label class="d-block text-white sign-up-lables text-left-en">{{__('Company')}} <span
                            class='signup-star'>*</span></label>
                ...
                <div class="forms-wrapper big-wrapper small text-right">
                    <label class="d-block text-white sign-up-lables text-left-en">{{__('Profession')}} <span
                            class='signup-star'>*</span></label>
            ...
            <div class="forms-container">
                ...
                <div class="forms-wrapper small text-right">
                    <label class="d-block text-white sign-up-lables text-left-en">{{__('Password')}} <span class='signup-star'>*</span></label>
                ...
                <div class="forms-wrapper small text-right">
                    <label class="d-block text-white sign-up-lables text-left-en">
                        {{__('Confirm Password')}}<span class='signup-star'>*</span>
                        <span class="float-left">
                            <a href="javascript:void(0);" class="text-warning show-text font-14-lh-30-light" style="position: absolute; top: 61px; @if($get_locale=='ar') left:12px @else right:0px @endif">
                                <p id='text'></p>
            ...
            <div class="forms-wrapper-policy-term big form-check text-right  align-items-center">
                <input type="checkbox" name="terms" class="form-check-input d-block" id="exampleCheck1 mb-3" required>
                <label class="form-check-label signup-form-check-label text-white font-14-lh-30-medium " style="font-family: 'Segoe UI';font-size: 22px; @if($get_locale=='ar') margin-inline-start: 28px; @endif"
                       for="exampleCheck1">{{__('I agree to Afdal Analytics ')}} <a class="text-white" href="{{ url('privacy-policy') }}" target="_blank">{{__('Privacy Policy')}}</a> {{__('and')}}
                    <a class="text-white" href="{{ url('cookie-policy') }}"
                       target="_blank">{{__('Cookie Policy')}}</a></label>
            </div>

            <div class="forms-wrapper text-center">
                <button type="submit" class="sign-up-btn btn btn-warning btn-md font-24-lh-28-medium" style="width: 590px;">
                    {{__('Sign Up')}}
                </button>
            </div>
        </form>
