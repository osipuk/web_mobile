...
{{--    </div>--}}
    ...
    <div class="contact-us-content">
        <h2 class="contact-us-title font-64-lh-75-semi-bold">
            {{__('Contact us')}}
        </h2>
        <h3 class="contact-us-subtitle font-22-lh-25-light">
...
{{--                </div>--}}
            ...
            <div class="input-wrapper">
                  <textarea class="contact-us-form-input textarea font-20-lh-42-regular"
                            placeholder="{{__('Message to the Afdal Analytics team*')}}"
                            rows="5"
                            maxlength="670"
            ...
            <p class="contact-us-form-info-text font-16-lh-19-light">
            ...
            <button
                type="submit"
                class="contact-us-form-button orange-button disabled" style="font-family: 'Gilroy-SemiBold';font-size: 20px;line-height: 23px;text-align: center;color: #FFFFFF;width: 192px;height: 65px;" disabled>
                {{__('Contact Us')}}
            </button>
