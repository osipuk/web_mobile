<html lang="en">
    <head>
        ...
        <meta name="keywords"
              content="أفضل التحليلات، تسويق الكتروني، ترويج، ستارت اب، ناشئة، مشروعات صغيرة، مواقع، تطبيقات، بيانات، تحليل السوق، تسويق، ماركتنج، فيسبوك، انستاجرام، جوجل، انالتكس،">
        <title>{{__("Analytics Campaign")}}</title>
        <meta name="description"
              content="فضل التحليلات هي وسيلتك للتعرف على كل ماتبحث عنه لقياس مؤشرات أداء وبيانات مشروعك على شبكة الإنترنت وشبكات التواصل الاجتماعي بطريقة سهلة وواضحة.">
 ...
 نصمم ونبرمج ونحلل ونجتهد لأجلك
        ...
        <div class="subscribe container">
            ...
            <form class="subscribe-form">
                ...
                <div id='select-country' class="input-wrapper">
                  <div id='country-icon' class="subscr-country-v-icon"></div>
                    <select id='select-input' class="subscribe__input country font-22-lh-32-medium placeholder-color"
                            name="country"
                ...
                {{--                       oninput="validateInput('country')"--}}
                {{--                />--}}
                <textarea class="contact-us-form-input subscribe__input textarea font-22-lh-32-medium"
        ...
        <div class="footer">
            ...
            <div class="footer__final-info">
                <div class="footer__final-info-social-block">
                    ...
                    <a class="icon instagram" target="_blanc" href="https://www.instagram.com/afdalanalytics"></a>
                    <a class="icon twitter" target="_blanc" href="https://twitter.com/afdalanalytics"></a>
                </div>
...
window.scrollTo({
  top: 0
    ...
    <script>
  const wrapSelect = document.querySelector('#select-country');
  const icon = document.querySelector('#country-icon');
  const list = document.querySelector('#select-input');

function rotateIcon() {
    icon.classList.add('role-rotate-icon')
}

document.addEventListener('mouseup', function(e) {
    const container = document.querySelector('.container');
    if (!container.contains(e.target)) {
      icon.classList.remove('role-rotate-icon');
    }
});

list.addEventListener('click', rotateIcon);
</script>
