               ...
               <div class="col-md-12">
                  <div class="register-box-body">
                    <div class="card shadow rounded-5 mt-3">
                        <div class="card-body">
                     <form id="add_form" action="{{asset('submit-glossary')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                    <textarea name="meta_keyword" id="meta_keyword" class="form-control" cols="40" rows="5" placeholder="Meta keyword">{!! @$getData['0']['meta_keyword'] !!}</textarea>
                                </div>
                                    </div>
                         </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">                              
                              <a href="{{asset('glossary')}}" class="btn btn-primary btn-block btn-flat">Back</a>
                           </div>
                        </div>
                     </form>
                  </div>
