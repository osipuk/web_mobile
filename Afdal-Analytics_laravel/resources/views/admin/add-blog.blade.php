...
@section('title', 'Afdal Analytics Blog')
@section('content')
               ...
               <div class="col-md-12">
                  <div class="register-box-body">
                     <div class="card shadow rounded-5 mt-3">
                        <div class="card-body">
                           <form id="add_form" action="{{asset('submit-blog')}}" method="post" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group has-feedback ">
                                       <img class="profile-user-img img-responsive" height="50px" width="100px" src="{{asset('public/images/blog-images')}}/{{@$getData['0']['image']}}">
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="form-group has-feedback">
                                       <textarea name="description" id="description" class="form-control" cols="60" rows="5" placeholder="Short Description">{!! @$getData['0']['description'] !!}</textarea>
                                       <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="row">
                                 ...
                                 <!-- /.col -->
                                 <div class="col-md-6">
                                    <a href="{{asset('blog')}}" class="btn btn-primary btn-block btn-flat">Back</a>
                                 </div>
                              </div>
                           </form>
                        </div>
