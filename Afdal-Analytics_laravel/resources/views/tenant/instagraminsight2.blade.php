                              ...
                              <div class="col-lg-3 col-sm-12 col-12">
                                 <div class="row">
                                          ...
                                          <div class="card-body text-right">
                                             ...
                                             <div class="d-flex-dashbard-data mt-3">
                                                ...
                                                <div class="dashboard-data-1 text-left">
                                                   <span class="alert alert-danger">0.6%<i class="fas fa-sort-down mr-3"></i></span>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Daily Active User</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                              ...
                              <div class="col-lg-9 col-sm-12 col-12">
                                 <div class="row">
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right">Daily Active Users</h5>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right">Installs By OS Version</h5>
                                             <div id="chart2"></div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right">Top Locations</h5>
                                             <div id="chartdiv"></div>
                                             <div class="bottom-charts">
                                                <ul class="text-right">
