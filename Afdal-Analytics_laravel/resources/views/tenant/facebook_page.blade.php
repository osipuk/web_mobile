                    ...
                    <div class="col-lg-9 col-sm-9 col-12">
                        <div class="dashboard-tabs">
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a class="nav-link active font-24-lh-29-medium pr-0"
                                    ...
                                    <div class="card big-card-height">
                                        <div class="card-body text-right">
                                            ...
                                            <div class="impressions-vs-clicks-table">
                                              ...
                                              <div class="data-sheet-metric data-sheet-metric--background-light-blue" id="impressionsVsClicksReach"></div>
                                        ...
                                        <div class="card-body text-right">
                                            ...
                                            <div class="d-flex-dashbard-data" id="mybasis">
                                                ...
                                                <div class="dashboard-data-2 text-right">
                                                    ...
                                                    <h3 class="font-37-lh-44-bold mb-0 card__total-title-count">{{$page_top_time_post ? $page_top_time_post . ':00' : '-'}}</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-xs-12">
                                    <div class="card small-card-height">
                                        <div class="card-body  text-right">
                                            ...
                                            <div class="d-flex-dashbard-data" id="mybasis">
                                                <div class="dashboard-data-1 text-left">
                                                    <img src="{{{url('/assets/image_new/svg/colored/page-engagements.svg')}}}">
                                                </div>
                                                <div class="dashboard-data-2 text-right">
                                                    ...
                                                    @foreach($page->post as $post)
                                                        <li class="post-card-item col-lg-6 col-xs-12">
                                                            ...
                                                            <div class="post-card-item-message">
                                                                <div class="post-card-item-message-name font-13-lh-16-medium">{{__('Message')}}<div class="message-orange-line"></div></div>
