                    ...
                    <div class="tab-pane active " id="ads-page">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="card big-card-height">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Total Page Likes Over Time')}}  </h5>
                                        <p class="font-16-lh-19-regular card__title-text">{{__('The total number of people who liked your page & posts')}}</p>
                                        <div style="width: 680px" id="likesChart"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="card small-card-height">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Unique Page Impressions')}} </h5>
                            ...
                            <div class="col-8">
                                <div class="card big-card-height">
                                    <div class="card-body text-right">
                                        ...
                                        <div style="width: 680px;" id="distributionChart"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-4">
                                    ...
                                    <div class="card-body  text-right">
                                        ...
                                        <div class="d-flex-dashbard-data" id="mybasis">
                                            ...
                                            <div class="dashboard-data-2 text-right">
                                                ...
                                                <h3 class="font-37-lh-44-bold mb-0 card__total-title-count">{{$page_engagement}}</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card small-card-height">
                                    <div class="card-body text-right">
                                        ...
                                        <p class="font-16-lh-19-regular mb-0">{{__('The total number of fans reach by a post')}}</p>
                                        <div class="d-flex-dashbard-data" id="mybasis">
                                            <div class="dashboard-data-1 text-left">
                                            ...
                                            <div class="dashboard-data-2 text-right">
                                                ...
                                                <h3 class="font-37-lh-44-bold mb-0 card__total-title-count">{{$post_reach_by_fans}}</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-8">
                                <div class="card big-card-height">
                                    <div class="card-body text-right">
                                        ...
                                        <div style="width: 680px;" id="engagementChart"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                        ...
                                        <div class="my-table table-responsive">
                                            <table class="table">
                                                ...
                                                @if(!empty($cta_data) && count($cta_data)>0)
                                                    ...
                                                    {{$item->city = str_replace('\'', '', $item->city)}}
                                                        <tr>
                                                            <th scope="row">{{$item?->city}}</th>
                                                            <td class="font-13-lh-20-regular">{{$item?->total_reach}}</td>
...
<script type="text/javascript">
    ...
    //console.log(offset, rotate, 'test', likeData, divWidth)
    var likesOptions = {
        series: [{
  ...
  `;
    ...
    offset = 0;
    rotate = 0;
    if(engagementData.dates.length>=20||(engagementData.dates.length>15&&divWidth<600)){
        offset = 20;
        rotate = -45;
    }
    ...
    console.log(engagementColWidth);
     ...
     offset = 0;
     rotate = 0;
    if(distributionData.dates.length>=20||(distributionData.dates.length>15&&divWidth<600)){
        offset = 20;
        rotate = -45;
    }
