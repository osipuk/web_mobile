                ...
                <div class="tab-pane active " id="ads-page">
                    <div class="row">
                        <div class="col-lg-4 col-xs-12">
                            <div class="card small-card-height">
                                <div class="card-body  text-right">
                                    <div class="top-content">
                                        <h5 class="font-21-lh-25 card__title">{{__('Impressions ')}} </h5>
                            ...
                            <div class="card small-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Click Through Rate')}}</h5>
                        ...
                        <div class="col-lg-8 col-xs-12">
                            <div class="card big-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Total Page Impressions And Clicks Over Time')}}  </h5>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-xs-12">
                            <div class="card small-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Total Clicks')}}</h5>
                        ...
                        <div class="col-lg-4 col-xs-12">
                            <div class="card small-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-252-bold card__title">{{__('Cost Per Click')}} </h5>
                        ...
                        <div class="col-lg-4 col-xs-12">
                            <div class="card small-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Total Link Clicks')}} </h5>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-xs-12">
                            <div class="card overflow-auto big-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Top Ad Sets')}}</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-xs-12">
                            <div class="card small-card-height">
                                <div class="card-body  text-right">
                                    <div class="top-content">
                                        <h5 class="font-21-lh-25 card__title">{{__('Average Cost To Reach 1000 Users')}} </h5>
                            ...
                            <div class="card small-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Total Spent On Ads')}}</h5>
                        ...
                        <div class="col-lg-8 col-xs-12">
                            <div class="card big-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Spend Vs Revenue')}}  </h5>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-xs-12">
                            <div class="card small-card-height">
                                <div class="card-body  text-right">
                                    <div class="top-content">
                                        <h5 class="font-21-lh-25 card__title">{{__('Average Cost For 1000 Impressions')}} </h5>
                            ...
                            <div class="card small-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Link Clicks')}}</h5>
                        ...
                        <div class="col-lg-8 col-xs-12">
                            <div class="card big-card-height">
                                <div class="card-body text-right">
                                    <h5 class="font-21-lh-25 card__title">{{__('Return On Advertising Spend')}}  </h5>
                    ...
                    @if(!empty($posts))
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <div class="card">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25 card__title">{{__('Top Performing Ads')}}</h5>
