                    ...
                    <div class="tab-pane active " id="ads-page">
                        <div class="row">
                            <div class="col-4">
                                <div class="card small-card-height">
                                    <div class="card-body  text-right">
                                        <div class="top-content">
                                            <h5 class="font-21-lh-25-bold card__title">{{__('Sessions per User')}} </h5>
                                ...
                                <div class="card small-card-height">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Active Users')}}</h5>
                            ...
                            <div class="col-8">
                                <div class="card big-card-height">
                                    <div class="card-body text-right">
                                        ...
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Users and New Users')}}  </h5>
                            ...
                            <div class="col-8">
                                <div class="card big-card-height">
                                    <div class="card-body text-right">
                                        ...
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Conversions')}}</h5>
                                        ...
                                        <div id="distributionChart" style="width: 680px !important"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="card big-card-height">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Top Acquisition Channels (Users)')}} </h5>
                        ...
                        <div class="row" style=" page-break-after: always; ">
                            <div class="col-4">
                                <div class="card small-card-height">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Average Time on Page')}}</h5>
                            ...
                            <div class="col-4">
                                <div class="card small-card-height">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Total Users')}} </h5>
                        ...
                        <div class="row" style="margin-top: 100px!important;">
                            <div class="col-6">
                                <div class="card big-card-height">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('What device are people using?')}}</h5>
                            ...
                            <div class="col-6">
                                <div class="card small-card-height">
                                    <div class="card-body  text-right">
                                        <div class="top-content">
                                            <h5 class="font-21-lh-25-bold card__title">{{__('User Engagement')}} </h5>
                                ...
                                <div class="card small-card-height">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Page View Per Session')}}</h5>
                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="card-body text-right">
                                        ...
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Country Breakdown')}}</h5>
                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="card-body text-right">
                                        ...
                                        <h5 class="font-21-lh-25-bold card__title">{{__('Active Users By Page Title')}}</h5>
                                                ...
                                                <div class='google-analytics-fifth-section'>
                                                    ...
                                                    @if(!empty($mostPopularPageTitles) && count($mostPopularPageTitles)>0)
                                                        @foreach($mostPopularPageTitles as $item)
                                                            <tr>
                                                                <th  class="font-13-lh-20-regular" scope="row1"> {{ $item->page_title }}</th>
                        ...
                        <div class="row" style="margin-top: 100px; margin-bottom: 50px;">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body text-right">
                                        <h5 class="font-21-lh-25-bold card__title">{{__('What sources are driving the most traffic to your page?')}}</h5>
...
<script type="text/javascript">
    ...
    offset = 0;
    rotate = 0;
    if(conversionsDates.length>30||(conversionsDates.length>15&&divWidth<750)){
        rotate = -45;
        offset = 20;
    }
