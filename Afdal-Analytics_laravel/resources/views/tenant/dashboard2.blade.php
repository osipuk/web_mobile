                  ...
                  <div class="col-lg-6 col-sm-6 col-12">
                     <div class="dashboard-tabs">
                        <ul class="nav nav-pills">
                           ...
                           <li class="nav-item">
                              <a class="nav-link active" data-toggle="tab" href="#fb-page-ads">Facebook Ads</a>
                           </li>
                           <li class="nav-item">
                              ...
                              <div class="col-lg-3 col-sm-12 col-12">
                                 <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Total Ad Clicks</h5>
                                    ...
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Total Ad Amount Spent</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                                                   <h3 class="font-weight-bold m-0">$1,285</h3>
                                                </div>
                                    ...
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Cost Per Ad Click</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                                                   <h3 class="font-weight-bold m-0">$44.00</h3>
                                                </div>
                                    ...
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Total Ad impressions</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                              ...
                              <div class="col-lg-9 col-sm-12 col-12">
                                 <div class="row">
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right">Daily Impressions</h5>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right"> Post Engagments</h5>
                                             <div id="chart"></div>
                                             <div class="bottom-charts">
                                                <ul class="text-right">
                                 ...
                                 <div class="row">
                                    <div class="col-lg-4 col-sm-12 col-12">
                                       ...
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Cost Per Conversion</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                                                   <h3 class="font-weight-bold m-0">$33.401</h3>
                                                </div>
                                       ...
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Click To Goal Rate</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                                                   <h3 class="font-weight-bold m-0">4.77%</h3>
                                                </div>
                                    ...
                                    <div class="card-body">
                                       <h5 class="font-weight-bold text-right">Campaign Overview</h5>
