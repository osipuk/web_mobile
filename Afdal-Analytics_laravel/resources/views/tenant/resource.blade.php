...
<div class="container mt-5">
	<div class="row">
			<div class="col-12">
				<h3 class="text-center mb-3">Guides that help you grow</h3>
                        <p class="text-center">Need a manual how to grow your business? <br>
                          Download our free marketing and growth resources
                        </p>
			</div>
		</div>
</div>
				...
				<div class="row">
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="resource-col text-center resource-col1">
							...
							<img src="{!!asset('public/assets/image/re1.jpg')!!}" class="shadow">
					...
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="resource-col text-center resource-col2">
							<h4 class="font-weight-bold">Guide Name</h4>
							<img src="{!!asset('public/assets/image/re2.jpg')!!}" class="shadow">
							<p>Need a manual how to grow your business?<br>Download our free marketing and growth</p>
							<p class="font-weight-bold m-0"><a href="#"><i class="fas fa-chevron-left mr-2"></i>Get the guide</a></p>
						</div>
					</div>
					...
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="resource-col text-center resource-col3">
							<h4 class="font-weight-bold">Guide Name</h4>
							<img src="{!!asset('public/assets/image/re3.jpg')!!}" class="shadow">
							<p>Need a manual how to grow your business?<br>Download our free marketing and growth</p>
							<p class="font-weight-bold m-0"><a href="#"><i class="fas fa-chevron-left mr-2"></i>Get the guide</a></p>
						</div>
					</div>
					...
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="resource-col text-center resource-col4">
							<h4 class="font-weight-bold">Guide Name</h4>
							<img src="{!!asset('public/assets/image/re4.jpg')!!}" class="shadow">
							<p>Need a manual how to grow your business?<br>Download our free marketing and growth</p>
							<p class="font-weight-bold m-0"><a href="#"><i class="fas fa-chevron-left mr-2"></i>Get the guide</a></p>
						</div>
					</div>
					...
					<div class="col-lg-6 col-sm-6 col-12">
						<div class="resource-col text-center resource-col5">
							<h4 class="font-weight-bold">Guide Name</h4>
							<img src="{!!asset('public/assets/image/re5.jpg')!!}" class="shadow">
							<p>Need a manual how to grow your business?<br>Download our free marketing and growth</p>
							<p class="font-weight-bold m-0"><a href="#"><i class="fas fa-chevron-left mr-2"></i>Get the guide</a></p>
						</div>
					</div>
         ...
         <div class="row">
            <div class="col-12">
               <div class="text-center mt-5">
                  <h3 class="mb-3">Get Our Latest <br>Resources In Your Inbox</h3>
                  
                  <div class="row">
                     <div class="col-lg-5 col-sm-6 col-12 mx-auto text-center">
                        <div class="join-col">
                           <div class="btn-vol-join">
                              <button class="btn join-btn m-0">JOIN</button>
                           </div>
                           <div class="form-col-join">
                              <div class="form-group m-0">
                                 <input type="text" class="form-control text-right m-0" placeholder="Your Email">
                              </div>
                           </div>
                        </div>
                     </div>
