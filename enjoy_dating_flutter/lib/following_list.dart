...
class Following_list extends StatefulWidget {
  ...
  const Following_list({Key? key, required this.user_id}) : super(key: key);

  @override
  _Following_listState createState() => _Following_listState();
}
...
class _Following_listState extends State<Following_list> {
  ...
  get_list() async {
    ...
    print('hello world');
    Map data = {'user_id': widget.user_id.toString(), 'status': 'following'};
              ...
              child: Column(
                ...
                children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: ()async {
                          ...
                          await push(context: context, screen: Single_Page(user_id:lists[i]['id']));
                          print('hiiiiiiii------');
                          get_list();
                        },
                        child: Container(
                  ...
                  if(!load&&lists.length==0)
                    Center(
                      child: new Text('No following yet.',style:TextStyle(color: Colors.white)),
                    ),
                ],
              ),
            ),
