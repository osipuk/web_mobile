...
class SearchLocationState extends State<SearchLocation> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _containerHeight = Tween<double>(begin: 48, end: 364).animate(
      CurvedAnimation(
      ...
      child: ListTile(
        title: Text(
          ...
          style: TextStyle(
            ...
            color: widget.darkMode ? Colors.white : Colors.grey[850],
          ),
          maxLines: 1,
        ),
  ...
  BoxDecoration _containerDecoration() {
    return BoxDecoration(
      color: widget.darkMode ? widget.bgColor :widget.bgColor,
      borderRadius: BorderRadius.all(Radius.circular(30.0)),
      border: Border.all(color: Color(0xFECBA7FF), width: 1)
  ...
  InputDecoration _inputStyle() {
    return InputDecoration(
      ...
      contentPadding: EdgeInsets.only(top: 12,left: 1),
      hintStyle: TextStyle(
        color:  Color(0xFEFFFFFF).withOpacity(0.8), fontWeight: FontWeight.w300,
        fontSize: 16
      ),
    );
  }
