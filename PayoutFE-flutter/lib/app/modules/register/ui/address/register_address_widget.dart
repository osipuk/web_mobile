...
class RegisterAddressWidget extends GeneralStatelessWidget {
  ...
  RegisterAddressWidget(
      this.latitude, this.longitude, this.firstName, this.lastName,
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: PoppinsText(
            ...
            fontSize: 12,
            content:
                'Hello $firstName $lastName, we use your address to verify your identity and also to curate your experience according to your neighborhood.',
          ),
        )
      ],
    );
